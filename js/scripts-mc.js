        ...
        function renderCards(showsArray) {
            if (showsArray.length > 0) {
                ...
                for (let show of showsArray) {
                    const summary = show.summary && show.summary.length > 2 ? (show.summary.length > 100 ? show.summary.substring(0, 100) + '...' : show.summary) : '';
                        ...
                        <div class="card card-home" style="display: none;">
                            ...
                            <div class="card text-center card-show">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="./details.html?id=${show.id}" class="btn btn-primary">Más sobre ${show.name}</a>
                                </div>
